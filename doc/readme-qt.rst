ConspiracyCoin-Qt: Qt4 GUI for ConspiracyCoin
===============================
...
A warning for people using the *static binary* version of ConspiracyCoin on a Linux/UNIX-ish system (tl;dr: **Berkely DB databases are not forward compatible**).

The static binary version of ConspiracyCoin is linked against libdb4.8 (see also `this Debian issue`_).
