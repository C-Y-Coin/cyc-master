...
See `doc/readme-qt.rst` for instructions on building ConspiracyCoin-Qt, the
...
A darkcoind binary is not included in the ConspiracyCoin-Qt.app bundle. You can ignore
...
on an OS X 10.6 64-bit machine fails. Official release builds of ConspiracyCoin-Qt are
compiled on an OS X 10.6 32-bit machine to workaround that problem.

Once dependencies are compiled, creating `ConspiracyCoin-Qt.app` is easy:
...
commands:
    ...
    echo -e "rpcuser=darkcoinrpc\nrpcpassword=$(xxd -l 16 -p /dev/urandom)" > "/Users/${USER}/Library/Application Support/ConspiracyCoin/darkcoin.conf"
    chmod 600 "/Users/${USER}/Library/Application Support/ConspiracyCoin/darkcoin.conf"
