TEMPLATE = app
TARGET = ConspiracyCoin-qt
macx:TARGET = "ConspiracyCoin-Qt"
VERSION = 1.6.1
...
OPENSSL_INCLUDE_PATH=c:/deps/open/include
OPENSSL_LIB_PATH=c:/deps/open
MINIUPNPC_LIB_PATH=c:/deps/mini/
MINIUPNPC_INCLUDE_PATH=c:/deps/mini
